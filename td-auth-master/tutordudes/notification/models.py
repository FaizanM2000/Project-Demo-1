...
class Notification(models.Model):
	...
	# The user that the creation of the notifications was triggered by.
	...
	redirect_url				= models.URLField(max_length=500, null=True, unique=False, blank=True, help_text="The URL to be visited when a notifications is clicked.")
	...
	# When the notifications was created/updated
